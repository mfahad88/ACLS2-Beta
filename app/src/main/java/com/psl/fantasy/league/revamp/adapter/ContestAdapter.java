...
//        TextView txt_contest_type_one=convertView.findViewById(R.id.txt_contest_type_one);
        ...
        if(!bean.getContest_type().equals("2")) {
        ...
        if(Integer.parseInt(bean.getDiscount())>0){
            ...
            btn_pay.setText("Rs. "+Helper.currencyFormatter(bean.getDiscount()));
        }else{
            if(bean.getActual_price().equalsIgnoreCase("0")){
                btn_pay.setText("join");
            }else {
                btn_pay.setText("Rs. " + Helper.currencyFormatter(bean.getActual_price()));
            }
        }
        ...
        txt_price.setText(Helper.currencyFormatter(bean.getPrice()));
