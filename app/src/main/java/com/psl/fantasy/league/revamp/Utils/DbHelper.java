...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public List<com.psl.fantasy.league.revamp.model.response.Player.Datum> getPlayers(String team_id){
        ...
        try {
            ...
            if (c.moveToFirst()) {
                do {
                    com.psl.fantasy.league.revamp.model.response.Player.Datum datum=new com.psl.fantasy.league.revamp.model.response.Player.Datum();
    ...
    public List<com.psl.fantasy.league.revamp.model.response.PrizeDistribution.Datum> getPrizeDistribution(){
        List<com.psl.fantasy.league.revamp.model.response.PrizeDistribution.Datum> list = new ArrayList<>();
        Cursor c = null ;
        try {
            ...
            if (c.moveToFirst()) {
                do {
                    com.psl.fantasy.league.revamp.model.response.PrizeDistribution.Datum bean=new com.psl.fantasy.league.revamp.model.response.PrizeDistribution.Datum();
    ...
    public long saveConfig(List<com.psl.fantasy.league.revamp.model.response.Config.Datum> list) {
        // Gets the data repository in write mode
        long processId = 0;
        SQLiteDatabase db=null;
        ...
        try{
            db = this.getWritableDatabase();
            ContentValues values = new ContentValues();
            for(com.psl.fantasy.league.revamp.model.response.Config.Datum datum:list){
    ...
    public long savePlayers(List<com.psl.fantasy.league.revamp.model.response.Player.Datum> list) {
        // Gets the data repository in write mode
        long processId = 0;
        SQLiteDatabase db=null;
        ...
        try{
            db = this.getWritableDatabase();
            ContentValues values = new ContentValues();
            for(com.psl.fantasy.league.revamp.model.response.Player.Datum datum:list){
    ...
    public long savePrizeDistribution(List<com.psl.fantasy.league.revamp.model.response.PrizeDistribution.Datum> list) {
        // Gets the data repository in write mode
        long processId = 0;
        SQLiteDatabase db=null;
        ...
        try{
            db = this.getWritableDatabase();
            ContentValues values = new ContentValues();
            for(com.psl.fantasy.league.revamp.model.response.PrizeDistribution.Datum datum:list){
